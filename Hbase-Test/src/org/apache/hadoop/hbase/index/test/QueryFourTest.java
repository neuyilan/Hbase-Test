...
public class QueryFourTest {
	...
	/**
//	 * select count(*),sum(c3),max(c3),min(c3) from orders where c3>200000 and c3<900000 and c5='5-LOW';
	 * 
	 * @throws Throwable 
	 */
	public  void queryFour() throws Throwable{
...
//			scan.setAttribute(IndexConstants.SCAN_WITH_INDEX, Bytes.toBytes(true));
	...
	public static void main(String[] args) throws Throwable{
		QueryFourTest test=new QueryFourTest();
