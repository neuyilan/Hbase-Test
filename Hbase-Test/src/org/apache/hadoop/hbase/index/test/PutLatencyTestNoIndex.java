...
public class PutLatencyTestNoIndex {
  ...
  public PutLatencyTestNoIndex() throws IOException {
    Configuration conf = HBaseConfiguration.create();
...
//        out.close();
        ...
        System.out.println("total time run :"+(stopTime - startTime) /  1000+" m");
...
//    System.out.println("----------------" + writeNum);
    ...
    PutLatencyTestNoIndex test = new PutLatencyTestNoIndex();
    test.start();
